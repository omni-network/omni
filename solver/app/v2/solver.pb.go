...
func file_solver_app_v2_solver_proto_rawDescGZIP() []byte {
	file_solver_app_v2_solver_proto_rawDescOnce.Do(func() {
		file_solver_app_v2_solver_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_solver_app_v2_solver_proto_rawDescData)))
	})
	return []byte(file_solver_app_v2_solver_proto_rawDescData)
}
