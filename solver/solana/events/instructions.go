...
var ProgramID ag_solanago.PublicKey = ag_solanago.MustPublicKeyFromBase58("36JFWdPhtSNoJ8h9YHwwc2WYL8rf1Xtxhxku51vh7J9E")
...
var (
	...
	Instruction_TestEvent = ag_binary.TypeID([8]byte{73, 92, 55, 0, 53, 248, 112, 109})

	Instruction_TestEventCpi = ag_binary.TypeID([8]byte{61, 120, 51, 92, 93, 89, 17, 176})
)
...
func InstructionIDToName(id ag_binary.TypeID) string {
	...
	case Instruction_Initialize:
		return "Initialize"
	case Instruction_TestEvent:
		return "TestEvent"
	case Instruction_TestEventCpi:
		return "TestEventCpi"
	default:
		return ""
	}
...
var InstructionImplDef = ag_binary.NewVariantDefinition(
	...
	[]ag_binary.VariantType{
		...
		{
			Name: "test_event", Type: (*TestEvent)(nil),
		},
		{
			Name: "test_event_cpi", Type: (*TestEventCpi)(nil),
		},
	},
)
