...
// DevMnemonic returns the mnemonic used for dev accounts.
func DevMnemonic() string {
	return "lemon prefer stereo virtual exact metal kit genuine journey detail ivory camera"
}
