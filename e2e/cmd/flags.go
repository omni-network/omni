...
func bindDefFlags(flags *pflag.FlagSet, cfg *app.DefinitionConfig) {
	...
	flags.StringVar(&cfg.HaloImgTag, "halo-image-tag", cfg.HaloImgTag, "Halo docker image tag. Defaults to working dir git commit.")
	flags.StringVar(&cfg.RelayerImgTag, "relayer-image-tag", cfg.RelayerImgTag, "Relayer docker image tag. Defaults to working dir git commit.")
	flags.StringVar(&cfg.MonitorImgTag, "monitor-image-tag", cfg.MonitorImgTag, "Monitor docker image tag. Defaults to working dir git commit.")
