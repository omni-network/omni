...
type CursorConfirmedIndexKey struct {
	vs []interface{}
}

func (x CursorConfirmedIndexKey) id() uint32            { return 1 }
func (x CursorConfirmedIndexKey) values() []interface{} { return x.vs }
func (x CursorConfirmedIndexKey) cursorIndexKey()       {}

func (this CursorConfirmedIndexKey) WithConfirmed(confirmed bool) CursorConfirmedIndexKey {
	this.vs = []interface{}{confirmed}
	return this
}

type CursorSrcChainIdDstChainIdConfLevelIndexKey struct {
	vs []interface{}
}

func (x CursorSrcChainIdDstChainIdConfLevelIndexKey) id() uint32            { return 2 }
func (x CursorSrcChainIdDstChainIdConfLevelIndexKey) values() []interface{} { return x.vs }
func (x CursorSrcChainIdDstChainIdConfLevelIndexKey) cursorIndexKey()       {}

func (this CursorSrcChainIdDstChainIdConfLevelIndexKey) WithSrcChainId(src_chain_id uint64) CursorSrcChainIdDstChainIdConfLevelIndexKey {
	this.vs = []interface{}{src_chain_id}
	return this
}

func (this CursorSrcChainIdDstChainIdConfLevelIndexKey) WithSrcChainIdDstChainId(src_chain_id uint64, dst_chain_id uint64) CursorSrcChainIdDstChainIdConfLevelIndexKey {
	this.vs = []interface{}{src_chain_id, dst_chain_id}
	return this
}

func (this CursorSrcChainIdDstChainIdConfLevelIndexKey) WithSrcChainIdDstChainIdConfLevel(src_chain_id uint64, dst_chain_id uint64, conf_level uint32) CursorSrcChainIdDstChainIdConfLevelIndexKey {
	this.vs = []interface{}{src_chain_id, dst_chain_id, conf_level}
	return this
}
