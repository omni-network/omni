...
var file_relayer_app_cursor_cursors_proto_rawDesc = string([]byte{
...
func file_relayer_app_cursor_cursors_proto_rawDescGZIP() []byte {
	file_relayer_app_cursor_cursors_proto_rawDescOnce.Do(func() {
		file_relayer_app_cursor_cursors_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_relayer_app_cursor_cursors_proto_rawDescData)))
	})
	return []byte(file_relayer_app_cursor_cursors_proto_rawDescData)
}
