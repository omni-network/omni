...
func file_octane_evmengine_keeper_evmengine_proto_rawDescGZIP() []byte {
	file_octane_evmengine_keeper_evmengine_proto_rawDescOnce.Do(func() {
		file_octane_evmengine_keeper_evmengine_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_octane_evmengine_keeper_evmengine_proto_rawDescData)))
	})
	return []byte(file_octane_evmengine_keeper_evmengine_proto_rawDescData)
}
