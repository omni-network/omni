...
/**
 * @title PortalAdmin
 * @notice A colleciton of admin scripts for the OmniPortal contract.
 */
contract PortalAdmin is Script {
     ...
     */
    function pause(address admin, address portal) public {
     ...
     * @param portal    The address of the portal contract.
     */
    function unpause(address admin, address portal) public {
        vm.startBroadcast(admin);
     ...
     */
    function upgrade(address admin, address deployer, address portal, bytes calldata data) public {
