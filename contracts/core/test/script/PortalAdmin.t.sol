...
import { PortalAdmin } from "script/admin/PortalAdmin.s.sol";
...
/**
 * @title PortalAdmin_Test
 * @notice Test suite for PortalAdmin script.
 */
contract PortalAdmin_Test is Test {
    // test chain Ids, used to set network and make test xcalls
    uint64 constant thisChainId = 1;
    uint64 constant thatChainId = 2;

    function test_pause_unpause() public {
        PortalAdmin a = new PortalAdmin();
    ...
    function test_upgrade() public {
        ...
        a.upgrade(admin, deployer, portal, upgradeCalldata);
