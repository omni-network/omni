...
import "eigenlayer-contracts/src/contracts/core/DelegationManagerStorage.sol";
...
/**
 * @dev Copied from eignlayer-contracts src/contracts/core/DelgationManager.sol. This contract contains all DelegationManager
 *      logic, with some checks removed for testing purposes -
 *           - registerOperatorToAVS signature checks removed
 *
 * @custom:attribution https://github.com/Layr-Labs/eigenlayer-contracts/blob/m2-mainnet/src/contracts/core/DelegationManager.sol
 */
    ...
    ReentrancyGuardUpgradeable
{
        ...
        returns (bytes32[] memory)
    {
        ...
        for (uint256 i = 0; i < queuedWithdrawalParams.length; i++) {
            ...
            require(
                ...
                "DelegationManager.queueWithdrawal: must provide valid withdrawal address"
            );
    ...
    function registerOperatorToAVS(
        ...
        require(
            isOperator(operator), "DelegationManager.registerOperatorToAVS: operator not registered to EigenLayer yet"
        );
    ...
    function _completeQueuedWithdrawal(
        ...
        require(pendingWithdrawals[withdrawalRoot], "DelegationManager.completeQueuedAction: action is not in queue");
