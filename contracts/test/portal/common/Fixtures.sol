...
contract Fixtures is CommonBase, StdCheats {
    ...
    uint64 constant omniConsensusChainId = 1_000_166;
    ...
    function _addValidatorSet_xblock(uint64 valSetId) internal view returns (TestXTypes.Block memory) {
        ...
        xmsgs[0] = XTypes.Msg({
            sourceChainId: omniConsensusChainId,
        ...
        return TestXTypes.Block(XTypes.BlockHeader(omniConsensusChainId, valSetId, bytes32(0)), xmsgs);
    }
