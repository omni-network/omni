...
// Order is a free data retrieval call binding the contract method 0xdb9c74bf.
//
// Solidity: function order(((address,uint64,uint32),(address,uint96),(address,bytes4,uint256,bytes)[],(address,address,uint96)[],address,uint256,bytes) ) view returns()
