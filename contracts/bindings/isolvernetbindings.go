...
// OrderData is a free data retrieval call binding the contract method 0xcf2d2dfa.
//
// Solidity: function orderData((address,(uint64,bytes32,uint256,bytes,(bytes32,bytes32,uint256)[]),(bytes32,uint256)[]) ) view returns()
