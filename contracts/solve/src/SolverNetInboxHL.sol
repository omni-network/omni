...
import { ISolverNetInboxHL } from "./interfaces/ISolverNetInboxHL.sol";
...
/**
 * @title SolverNetInboxHL
 * @dev This version is capable of receiving messages from non-Core chains via Hyperlane in addition to Omni Core.
 * @notice Entrypoint and alt-mempool for user solve orders.
 */
contract SolverNetInboxHL is
    OwnableRoles,
    ReentrancyGuard,
    Initializable,
    DeployedAt,
