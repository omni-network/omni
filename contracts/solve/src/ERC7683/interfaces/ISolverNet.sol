...
interface ISolverNet {
    /**
     * @notice ERC20 pre-requisite for an order to be fulfilled on another chain.
    ...
    /**
     * @notice Details of a call to be fulfilled on another chain.
     ...
     * @param tokenPrereqs  Array of token pre-requisites (including natives) for the request to be fulfilled on the destination chain.
