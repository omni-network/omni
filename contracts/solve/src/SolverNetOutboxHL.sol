...
import { ISolverNetOutboxHL } from "./interfaces/ISolverNetOutboxHL.sol";
...
/**
 * @title SolverNetOutboxHL
 * @dev This version is capable of sending messages to non-Core chains via Hyperlane in addition to Omni Core.
 * @notice Entrypoint for fulfillments of user solve requests.
 */
contract SolverNetOutboxHL is
    OwnableRoles,
    ReentrancyGuard,
    Initializable,
    DeployedAt,
    ...
    ISolverNetOutboxHL
{
    ...
    /**
     * @notice Initialize the contract's Hyperlane hook and interchain security module.
     */
