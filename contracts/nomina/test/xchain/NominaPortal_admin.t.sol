...
/**
 * @title NominaPortal_admin_Test
 * @dev Test of NominaPortal admin controls
 */
contract NominaPortal_admin_Test is Base {
    function test_setFeeOracle() public {
        ...
        // cannot be zero
        vm.prank(owner);
        vm.expectRevert("NominaPortal: no zero feeOracle");
    ...
    function test_pauseAll() public {
        ...
        vm.expectRevert("NominaPortal: paused");
        vm.chainId(thisChainId);
    ...
    function test_pauseXSubmit() public {
        ...
        // when not paused, xsubmit should error with "NominaPortal: no xmsgs"
        // when paused, xsubmit should error with "NominaPortal: paused"
    ...
    function test_setXMsgGasLimits() public {
        ...
        vm.expectRevert("NominaPortal: not below max");
        portal.setXMsgMinGasLimit(max);

        // max must be above min
        vm.expectRevert("NominaPortal: not above min");
