...
/**
 * @title NominaPortalConstants
 * @notice Constants used by the NominaPortal contract
 */
contract NominaPortalConstants {
    /**
    ...
    /**
     * @dev xmsg.sender for xmsgs from Nomina's consensus chain
     */
