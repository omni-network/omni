...
Asset prices fluctuate constantly. To ensure users see up-to-date rates and minimize potential slippage or order rejection by solvers, refresh quotes frequently using [`useQuote`](/sdk/hooks/useQuote.md). A common UX pattern is to refresh every 15-30 seconds.
