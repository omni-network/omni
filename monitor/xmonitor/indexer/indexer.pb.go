...
func file_monitor_xmonitor_indexer_indexer_proto_rawDescGZIP() []byte {
	file_monitor_xmonitor_indexer_indexer_proto_rawDescOnce.Do(func() {
		file_monitor_xmonitor_indexer_indexer_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_monitor_xmonitor_indexer_indexer_proto_rawDescData)))
	})
	return []byte(file_monitor_xmonitor_indexer_indexer_proto_rawDescData)
}
