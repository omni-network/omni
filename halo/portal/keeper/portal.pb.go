...
type Block struct {
	...
	Id            uint64                 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`                                            // Auto-incremented ID (also used as BlockHeight and AttestOffset)
	CreatedHeight uint64                 `protobuf:"varint,2,opt,name=created_height,json=createdHeight,proto3" json:"created_height,omitempty"` // Consensus height this block was created at.
...
const file_halo_portal_keeper_portal_proto_rawDesc = "" +
	"\n" +
	"\x1fhalo/portal/keeper/portal.proto\x12\x12halo.portal.keeper\x1a\x17cosmos/orm/v1/orm.proto\"f\n" +
	"\x05Block\x12\x0e\n" +
	...
	"\bblock_id\x18\x02 \x01(\x04R\ablockId\x12\x19\n" +
	"\bmsg_type\x18\x03 \x01(\rR\amsgType\x12\x1e\n" +
	"\vmsg_type_id\x18\x04 \x01(\x04R\tmsgTypeId\x12\"\n" +
	"\rdest_chain_id\x18\x05 \x01(\x04R\vdestChainId\x12\x19\n" +
	"\bshard_id\x18\x06 \x01(\x04R\ashardId\x12#\n" +
	"\rstream_offset\x18\a \x01(\x04R\fstreamOffset:\x1e\xf2\x9eӎ\x03\x18\n" +
	"\x06\n" +
	"\x02id\x10\x01\x12\f\n" +
	"\bblock_id\x10\x02\x18\x02\"\x9f\x01\n" +
	"\x06Offset\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\"\n" +
	"\rdest_chain_id\x18\x02 \x01(\x04R\vdestChainId\x12\x19\n" +
	"\bshard_id\x18\x03 \x01(\x04R\ashardId\x12\x16\n" +
	"\x06offset\x18\x04 \x01(\x04R\x06offset:.\xf2\x9eӎ\x03(\n" +
	"\x06\n" +
	"\x02id\x10\x01\x12\x1c\n" +
	"\x16dest_chain_id,shard_id\x10\x02\x18\x01\x18\x03B\xc0\x01\n" +
	"\x16com.halo.portal.keeperB\vPortalProtoP\x01Z/github.com/omni-network/omni/halo/portal/keeper\xa2\x02\x03HPK\xaa\x02\x12Halo.Portal.Keeper\xca\x02\x12Halo\\Portal\\Keeper\xe2\x02\x1eHalo\\Portal\\Keeper\\GPBMetadata\xea\x02\x14Halo::Portal::Keeperb\x06proto3"

var (
	file_halo_portal_keeper_portal_proto_rawDescOnce sync.Once
	file_halo_portal_keeper_portal_proto_rawDescData []byte
)

func file_halo_portal_keeper_portal_proto_rawDescGZIP() []byte {
	file_halo_portal_keeper_portal_proto_rawDescOnce.Do(func() {
		file_halo_portal_keeper_portal_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_halo_portal_keeper_portal_proto_rawDesc), len(file_halo_portal_keeper_portal_proto_rawDesc)))
	})
...
func file_halo_portal_keeper_portal_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_halo_portal_keeper_portal_proto_rawDesc), len(file_halo_portal_keeper_portal_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
