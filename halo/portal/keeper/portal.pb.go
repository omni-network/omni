...
type Block struct {
	...
	Id            uint64                 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`                                            // Auto-incremented ID (BlockHeight, AttestOffset)
...
func file_halo_portal_keeper_portal_proto_rawDescGZIP() []byte {
	file_halo_portal_keeper_portal_proto_rawDescOnce.Do(func() {
		file_halo_portal_keeper_portal_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_halo_portal_keeper_portal_proto_rawDescData)))
	})
	return []byte(file_halo_portal_keeper_portal_proto_rawDescData)
}
