...
func (w *BankWrapper) UndelegateCoinsFromModuleToAccount(ctx context.Context, senderModule string, recipientAddr sdk.AccAddress, coins sdk.Coins) error {
	...
	if err := w.Keeper.SendCoinsFromAccountToModule(ctx, recipientAddr, senderModule, coins); err != nil {
	...
	if err := w.createWithdrawal(ctx, senderModule, recipientAddr, coins); err != nil {
...
func (w *BankWrapper) createWithdrawal(ctx context.Context, senderModule string, recipientAddr sdk.AccAddress, coins sdk.Coins) error {
