...
// Source: halo/valsync/testutil/expected_interfaces.go
//
...
func (m *MockSubscriber) UpdateValidatorSet(valset *types2.ValidatorSetResponse) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateValidatorSet", valset)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateValidatorSet indicates an expected call of UpdateValidatorSet.
func (mr *MockSubscriberMockRecorder) UpdateValidatorSet(valset any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateValidatorSet", reflect.TypeOf((*MockSubscriber)(nil).UpdateValidatorSet), valset)
}
