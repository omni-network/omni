...
func file_halo_valsync_keeper_valsync_proto_rawDescGZIP() []byte {
	file_halo_valsync_keeper_valsync_proto_rawDescOnce.Do(func() {
		file_halo_valsync_keeper_valsync_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_halo_valsync_keeper_valsync_proto_rawDescData)))
	})
	return []byte(file_halo_valsync_keeper_valsync_proto_rawDescData)
}
