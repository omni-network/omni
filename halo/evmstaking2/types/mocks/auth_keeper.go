...
// AuthKeeper is an autogenerated mock type for the AuthKeeper type
type AuthKeeper struct {
	mock.Mock
}

// HasAccount provides a mock function with given fields: ctx, addr
func (_m *AuthKeeper) HasAccount(ctx context.Context, addr types.AccAddress) bool {
...
func (_m *AuthKeeper) NewAccountWithAddress(ctx context.Context, addr types.AccAddress) types.AccountI {
	ret := _m.Called(ctx, addr)
...
func (_m *AuthKeeper) SetAccount(ctx context.Context, acc types.AccountI) {
	_m.Called(ctx, acc)
}

// NewAuthKeeper creates a new instance of AuthKeeper. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewAuthKeeper(t interface {
	mock.TestingT
	Cleanup(func())
}) *AuthKeeper {
	mock := &AuthKeeper{}
