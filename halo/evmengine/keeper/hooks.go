...
func (Hooks) AfterValidatorBonded(ctx context.Context, consAddr sdk.ConsAddress, valAddr sdk.ValAddress) error {
	log.Info(ctx, "📚 Validator bonded", "cons_addr", consAddr, "val_addr", valAddr)
	return nil
}
