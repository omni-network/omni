...
func (this AggAttestationStatusChainIdHeightIndexKey) WithStatus(status int32) AggAttestationStatusChainIdHeightIndexKey {
	this.vs = []interface{}{status}
	return this
}

func (this AggAttestationStatusChainIdHeightIndexKey) WithStatusChainId(status int32, chain_id uint64) AggAttestationStatusChainIdHeightIndexKey {
	this.vs = []interface{}{status, chain_id}
	return this
}

func (this AggAttestationStatusChainIdHeightIndexKey) WithStatusChainIdHeight(status int32, chain_id uint64, height uint64) AggAttestationStatusChainIdHeightIndexKey {
