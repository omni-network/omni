...
type Attestation struct {
	...
	Offset          uint64 `protobuf:"varint,3,opt,name=offset,proto3" json:"offset,omitempty"`                                         // Offset of the cross chain block
	Height          uint64 `protobuf:"varint,4,opt,name=height,proto3" json:"height,omitempty"`                                         // Height of the source chain block
	Hash            []byte `protobuf:"bytes,5,opt,name=hash,proto3" json:"hash,omitempty"`                                              // Hash of the source chain block
	AttestationRoot []byte `protobuf:"bytes,6,opt,name=attestation_root,json=attestationRoot,proto3" json:"attestation_root,omitempty"` // Attestation merkle root of the cross-chain Block
	Status          int32  `protobuf:"varint,7,opt,name=status,proto3" json:"status,omitempty"`                                         // Status of the block; pending, approved.
	ValidatorSetId  uint64 `protobuf:"varint,8,opt,name=validator_set_id,json=validatorSetId,proto3" json:"validator_set_id,omitempty"` // Validator set that approved this attestation.
	CreatedHeight   uint64 `protobuf:"varint,9,opt,name=created_height,json=createdHeight,proto3" json:"created_height,omitempty"`      // Consensus height at which this attestation was created.
}
...
var file_halo_attest_keeper_attestation_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x86, 0x03, 0x0a, 0x0b, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74,
	...
	,
	...
	,
	...
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x2b, 0x0a, 0x11, 0x76, 0x61, 0x6c, 0x69,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x15, 0x0a, 0x06, 0x61, 0x74, 0x74, 0x5f, 0x69, 0x64, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x61, 0x74, 0x74, 0x49, 0x64, 0x3a, 0x3c, 0xf2, 0x9e,
	0xd3, 0x8e, 0x03, 0x36, 0x0a, 0x06, 0x0a, 0x02, 0x69, 0x64, 0x10, 0x01, 0x12, 0x1e, 0x0a, 0x18,
	0x61, 0x74, 0x74, 0x5f, 0x69, 0x64, 0x2c, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72,
	0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x10, 0x01, 0x18, 0x01, 0x12, 0x0a, 0x0a, 0x06,
	0x61, 0x74, 0x74, 0x5f, 0x69, 0x64, 0x10, 0x02, 0x18, 0x02, 0x2a, 0x30, 0x0a, 0x06, 0x53, 0x74,
	...
	0x0a, 0x08, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x64, 0x10, 0x02, 0x42, 0xc5, 0x01, 0x0a,
	0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x68, 0x61, 0x6c, 0x6f, 0x2e, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74,
	0x2e, 0x6b, 0x65, 0x65, 0x70, 0x65, 0x72, 0x42, 0x10, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61,
	...
	0x74, 0x74, 0x65, 0x73, 0x74, 0x2f, 0x6b, 0x65, 0x65, 0x70, 0x65, 0x72, 0xa2, 0x02, 0x03, 0x48,
	0x41, 0x4b, 0xaa, 0x02, 0x12, 0x48, 0x61, 0x6c, 0x6f, 0x2e, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74,
	0x2e, 0x4b, 0x65, 0x65, 0x70, 0x65, 0x72, 0xca, 0x02, 0x12, 0x48, 0x61, 0x6c, 0x6f, 0x5c, 0x41,
	0x74, 0x74, 0x65, 0x73, 0x74, 0x5c, 0x4b, 0x65, 0x65, 0x70, 0x65, 0x72, 0xe2, 0x02, 0x1e, 0x48,
	0x61, 0x6c, 0x6f, 0x5c, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x5c, 0x4b, 0x65, 0x65, 0x70, 0x65,
	0x72, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x14,
	0x48, 0x61, 0x6c, 0x6f, 0x3a, 0x3a, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x3a, 0x3a, 0x4b, 0x65,
