...
var file_halo_attest_keeper_attestation_proto_rawDesc = string([]byte{
...
func file_halo_attest_keeper_attestation_proto_rawDescGZIP() []byte {
	file_halo_attest_keeper_attestation_proto_rawDescOnce.Do(func() {
		file_halo_attest_keeper_attestation_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_halo_attest_keeper_attestation_proto_rawDescData)))
	})
	return []byte(file_halo_attest_keeper_attestation_proto_rawDescData)
}
