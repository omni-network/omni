...
type Portal struct {
	...
	BlockPeriodMs  uint64   `protobuf:"varint,6,opt,name=block_period_ms,json=blockPeriodMs,proto3" json:"block_period_ms,omitempty"`  // The block period of the chain deployed to, in milliseconds.
...
func (x *Portal) GetBlockPeriodMs() uint64 {
	if x != nil {
		return x.BlockPeriodMs
	}
	return 0
}
...
var file_halo_registry_keeper_registry_proto_rawDesc = []byte{
	...
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x5f, 0x6d, 0x73, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0d, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x50, 0x65, 0x72, 0x69,
	0x6f, 0x64, 0x4d, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01,
