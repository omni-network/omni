...
var file_halo_registry_keeper_registry_proto_goTypes = []interface{}{
...
func file_halo_registry_keeper_registry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_halo_registry_keeper_registry_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_halo_registry_keeper_registry_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Portal); i {
			case 0:
				return &v.state
			case 1:
