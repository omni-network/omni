...
func file_halo_registry_keeper_registry_proto_rawDescGZIP() []byte {
	file_halo_registry_keeper_registry_proto_rawDescOnce.Do(func() {
		file_halo_registry_keeper_registry_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_halo_registry_keeper_registry_proto_rawDescData)))
	})
	return []byte(file_halo_registry_keeper_registry_proto_rawDescData)
}
