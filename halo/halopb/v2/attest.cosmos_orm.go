...
type AggAttestationStatusIndexKey struct {
	vs []interface{}
}

func (x AggAttestationStatusIndexKey) id() uint32              { return 2 }
func (x AggAttestationStatusIndexKey) values() []interface{}   { return x.vs }
func (x AggAttestationStatusIndexKey) aggAttestationIndexKey() {}

func (this AggAttestationStatusIndexKey) WithStatus(status uint32) AggAttestationStatusIndexKey {
...
func (x AttSignatureAggIdIndexKey) id() uint32            { return 1 }
func (x AttSignatureAggIdIndexKey) values() []interface{} { return x.vs }
func (x AttSignatureAggIdIndexKey) attSignatureIndexKey() {}

func (this AttSignatureAggIdIndexKey) WithAggId(agg_id []byte) AttSignatureAggIdIndexKey {
...
func (x attestStore) AggAttestationTable() AggAttestationTable {
	return x.aggAttestation
}

func (x attestStore) AttSignatureTable() AttSignatureTable {
	return x.attSignature
}

func (attestStore) doNotImplement() {}

var _ AttestStore = attestStore{}

func NewAttestStore(db ormtable.Schema) (AttestStore, error) {
