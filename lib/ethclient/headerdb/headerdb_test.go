...
func noFetch(context.Context, common.Hash) (*types.Header, error) {
...
func assertNotExists(ctx context.Context, t *testing.T, db *headerdb.DB, headers ...*types.Header) {
	t.Helper()
...
func assertExists(ctx context.Context, t *testing.T, db *headerdb.DB, headers ...*types.Header) {
	t.Helper()
